...
public class SwaggerConfig {
	...
	private SecurityScheme securityScheme() {
		...
		LoginEndpoint loginEndpoint = new LoginEndpointBuilder().url(authServer + "/realms/" + realm + "/protocol/openid-connect/auth").build();
		
		GrantType grantType = new ImplicitGrantBuilder().loginEndpoint(loginEndpoint).tokenName(APP_NAME).build();
